...
The main way to get help is on our [discord server](https://discord.gg/aHaSw9zgwV).
...
need to be the best programmer to contribute. Our discord is open for questions.
 ...
 6. **Build** the project
    - For a detailed look on how to build tomb look at our
 ...
 9. Ensure that the code that you made follows our Rust **coding guidelines**
    ...
    - Easier yet run `cargo fmt` and `cargo clippy` to automatically format your
      code and check for common mistakes. Our CI will also run these commands on your Pull Request.
      If they raise any errors, you will need to fix them before your Pull Request can be merged.
