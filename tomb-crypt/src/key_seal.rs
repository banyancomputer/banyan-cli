...
const TEST_PEM_KEY: &[u8] = &[
    ...
    45, 45, 45, 10, 77, 73, 71, 50, 65, 103, 69, 65, 77, 66, 65, 71, 66, 121, 113, 71, 83, 77, 52,
    57, 65, 103, 69, 71, 66, 83, 117, 66, 66, 65, 65, 105, 66, 73, 71, 101, 77, 73, 71, 98, 65,
    103, 69, 66, 66, 68, 67, 114, 72, 75, 99, 85, 106, 122, 102, 84, 102, 49, 105, 48, 47, 80, 79,
    53, 10, 49, 121, 111, 56, 102, 97, 97, 89, 112, 89, 100, 84, 105, 70, 81, 81, 65, 111, 100, 85,
    75, 113, 103, 86, 106, 70, 107, 83, 43, 98, 75, 66, 50, 112, 122, 86, 118, 85, 122, 90, 68,
    117, 120, 68, 84, 109, 54, 104, 90, 65, 78, 105, 65, 65, 82, 43, 120, 74, 89, 50, 82, 82, 68,
    88, 10, 88, 72, 55, 50, 112, 89, 74, 85, 54, 79, 81, 65, 80, 102, 74, 110, 80, 86, 53, 97, 115,
    121, 112, 87, 72, 100, 54, 98, 104, 56, 75, 50, 81, 77, 101, 49, 117, 77, 73, 97, 105, 71, 70,
    85, 117, 90, 84, 75, 71, 111, 121, 112, 48, 81, 72, 84, 67, 117, 107, 111, 115, 68, 117, 69,
    10, 76, 52, 101, 48, 52, 51, 74, 50, 103, 115, 101, 119, 65, 85, 82, 80, 49, 115, 111, 69, 101,
    105, 104, 103, 109, 97, 81, 112, 55, 73, 68, 72, 115, 67, 56, 70, 107, 108, 66, 103, 71, 74,
    90, 68, 112, 56, 100, 108, 116, 99, 117, 89, 84, 110, 77, 61, 10, 45, 45, 45, 45, 45, 69, 78,
    68, 32, 80, 82, 73, 86, 65, 84, 69, 32, 75, 69, 89, 45, 45, 45, 45, 45, 10,
];

#[cfg(test)]
const TEST_DER_KEY: &[u8] = &[
    48, 129, 164, 2, 1, 1, 4, 48, 171, 28, 167, 20, 143, 55, 211, 127, 88, 180, 252, 243, 185, 215,
    42, 60, 125, 166, 152, 165, 135, 83, 136, 84, 16, 2, 135, 84, 42, 168, 21, 140, 89, 18, 249,
    178, 129, 218, 156, 213, 189, 76, 217, 14, 236, 67, 78, 110, 160, 7, 6, 5, 43, 129, 4, 0, 34,
    161, 100, 3, 98, 0, 4, 126, 196, 150, 54, 69, 16, 215, 92, 126, 246, 165, 130, 84, 232, 228, 0,
    61, 242, 103, 61, 94, 90, 179, 42, 86, 29, 222, 155, 135, 194, 182, 64, 199, 181, 184, 194, 26,
    136, 97, 84, 185, 148, 202, 26, 140, 169, 209, 1, 211, 10, 233, 40, 176, 59, 132, 47, 135, 180,
    227, 114, 118, 130, 199, 176, 1, 68, 79, 214, 202, 4, 122, 40, 96, 153, 164, 41, 236, 128, 199,
    176, 47, 5, 146, 80, 96, 24, 150, 67, 167, 199, 101, 181, 203, 152, 78, 115,
];
...
#[cfg(test)]
async fn _test_pem_key_parse_and_use() -> Result<(), KeySealError> {
...
#[cfg(test)]
async fn _test_der_key_parse_and_use() -> Result<(), KeySealError> {
    use crate::key_seal::common::{ProtectedKey, WrappingPrivateKey};
